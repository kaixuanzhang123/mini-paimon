...
public class SQLSelectTest {
    ...
    private static void insertDataWithoutClosing(PathFactory pathFactory, TableManager tableManager) throws IOException {
        ...
        try {
            // 插入数据
            lsmTree.put(new com.minipaimon.metadata.Row(new Object[]{1, "Alice", 25}));
            System.out.println("插入数据: (1, 'Alice', 25)");
            
            lsmTree.put(new com.minipaimon.metadata.Row(new Object[]{2, "Bob", 30}));
            System.out.println("插入数据: (2, 'Bob', 30)");
            
            lsmTree.put(new com.minipaimon.metadata.Row(new Object[]{3, "Charlie", 35}));
